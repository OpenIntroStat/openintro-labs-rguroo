...
1.  Lastly, try one more (different) confidence level. First, state how you expect the
    ...
    use the *climate_change_bootstrap* dataset to calculate the bounds of the interval and interpret it. Finally, use the *climate_change_1000_CIs* dataset to generate 1000 intervals using the Central Limit Theorem and calculate the proportion of intervals that capture the true population proportion.
