...
Once you log in to your Rguroo account, you should see a fairly open browser window similar to that shown below.

```{r rguroo-interface-2020, echo=FALSE, results="asis", fig.cap="*A view of the Rguroo interface*", fig.align='center', outwidth = "80%"}
knitr::include_graphics("img/rguroo-interface-v1_9_7.png")
```
...
As you add Rguroo objects to your account, it will become difficult to immediately find the object you want. Thus, you can type text in the "Search" box to filter the objects in each section. You can also take advantage of the folder system to organize your objects.
...
1. In the **Data Viewer**, view *only* the counts of girls baptized by right-clicking on one of the columns and deselecting all variables except for "girls." Take a screenshot showing (at least) the first ten cases and include it below.
...
* You can click on the ![Quick Users Guide](img/Quick_Users_Guide_Icon.png) icon that appears on top of the Rguroo application to get quick instructions on how to perform various tasks in Rguroo.
